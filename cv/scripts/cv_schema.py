...
class BuildConfig(BaseModel):
    ...
    company_accent_color: Optional[str] = Field(None, description="A 6-character HEX color code representing the target company's primary brand color (e.g., 'FF0000'). Do NOT include the '#' symbol.")
    profile: str = Field(..., description="Highly tailored 3-4 sentence professional profile")
